    ...
    <div className="mx-auto max-w-md p-6">
      ...
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <label className="block">
          ...
          <input value={name} onChange={(e) => setName(e.target.value)} type="text" className="w-full rounded border px-3 py-2" />
        </label>
        ...
        <div className="flex justify-end gap-2">
          <button type="submit" className="rounded bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground">Create account</button>
        </div>
      </form>
    </div>
  );
